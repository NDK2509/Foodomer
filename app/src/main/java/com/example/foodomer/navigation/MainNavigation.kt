    ...
    Scaffold(
        bottomBar = {
            BottomBar(
                ...
                items = listOf(
                    BottomBarItemProps(
                        icon = painterResource(R.drawable.icon_menu), destination = Destinations.Home.route
                    ),
                    BottomBarItemProps(
                        icon = painterResource(R.drawable.icon_menu), destination = Destinations.Randomizer.route
                    ),
                    BottomBarItemProps(
                        icon = painterResource(R.drawable.icon_menu), destination = Destinations.History.route
                    )
                )
            )
        },
...
//            composable(Destinations.Test.route) { TestScreen() }
